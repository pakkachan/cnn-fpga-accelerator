...
\
  ...
  # Create instance: top_layer_0, and set properties
  set block_name top_layer
  set block_cell_name top_layer_0
  if { [catch {set top_layer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $top_layer_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins top_layer_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins top_layer_0/s_axi]
  ...
  connect_bd_intf_net -intf_net top_layer_0_m_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins top_layer_0/m_axis]
  ...
  assign_bd_address -offset 0x60000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs top_layer_0/s_axi/reg0] -force
  ...
  exclude_bd_addr_seg -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs top_layer_0/s_axi/reg0]
  ...
  exclude_bd_addr_seg -offset 0x60000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs top_layer_0/s_axi/reg0]
